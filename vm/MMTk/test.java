...
public class test 
{
    ...
    public static void main(String[] args) 
    {
        ...
        test.mc = SelectedPlan.ap.mutator();
        test.cc = SelectedPlan.ap.collector();
    ...
    {        
        ...
        {
            addr = test.mc.alloc(52, 0, 0, Plan.ALLOC_DEFAULT, 0);
    ...
    static void linkListOfLiveObjectsTest()
    {
        ...
        Address addrBaseObject = test.mc.alloc(52, 0, 0, Plan.ALLOC_DEFAULT, 0);
    ...
    static void linkListOfLiveObjectsTest2()
    {
        ...
        Address addr = test.mc.alloc(52, 0, 0, Plan.ALLOC_DEFAULT, 0);
    ...
    static void linkListOfArraysTest()
    {
        ...
        Address addrOA = test.mc.alloc(52, 0, 0, Plan.ALLOC_DEFAULT, 0);
